local locales = {
  ["ptBR"] = {
    ...
    ["Display Lowlevel Quest Givers"] = "Mostrar Provedores de Missões de Nível Baixo",
    ...
    ["Hold <Ctrl> To Hide Minimap Nodes"] = "Pressione <Ctrl> para Nós no Minimap",
    ["Horde"] = "Horda",
    ["Hostile"] = "Hostil",
    ...
    ["Loot"] = "Saque",
    ["Loot and/or Use |cff33ffcc[%s]|r from |cff33ffcc%s|r"] = "Saquear e/ou User |cff33ffcc[%s]|r de |cff33ffcc%s|r",
